...
//                            NSMutableArray * deletindexArr = [[NSMutableArray alloc]init];                            for (int i = 0; i<currentGroup.myContactArr.count; i++) {
//                                [deletindexArr addObject:[NSIndexPath indexPathForRow:i inSection:section]];
//                            }
//                          
//                            [self.tableView reloadRowsAtIndexPaths:[NSArray arrayWithObject:deletindexArr] withRowAnimation:UITableViewRowAnimationBottom];
//                            
                        }
